...
<div align="center">
  <img src="https://miro.medium.com/v2/resize:fit:1400/1*rc-6WRXseH1q1tqXJPP5jw.png" alt="Node.js"  />
</div>-->
...
- [Data Structures - Hard Code](https://youtube.com/playlist?list=PLwCMLs3sjOY4UQq4vXgGPwGLVX1Y5faaS&si=6Jv0oLsnTlXC_aUG)
...
<details>
  <summary>اساسيات ومفاهيم الشبكات</summary>

🛜 [IT DOSE](https://youtube.com/playlist?list=PL8s4OGp0649_e_Wbz5MlBgW5rBW-9hD0c&si=vS9s1HhCT4A7WchD)
...
### Frontend Basics 🎨
<div>
 <!-- <img src="https://hermes.dio.me/articles/cover/9771699c-9db6-41fc-830e-01640308091d.png" alt="cat-css" align="right" width="300" />
  -->
...
- HTML & CSS Crash Courses:
  ...
  - [HTML & CSS Crash Course - Yehia Tech](https://youtu.be/Pwatx1n1Ws0?si=mdXo0asa8cuZpu7C)
...
<details>
  <summary>Essential concepts to master:</summary>
  <br>
...
- [JavaScript Data Structures - Shadow Coding](https://youtube.com/playlist?list=PLS-MrzRLZtmdIHJ-Osvv_sJO1Msc4VM_7&si=qlX2jUIc8PDLAz2u)
- [CodeCademy JavaScript Course](https://www.codecademy.com/enrolled/courses/introduction-to-javascript)
- [Challenge 100 - Problem Solving in JS | بالعربي](https://youtube.com/playlist?list=PL3iticg1TvA-jMsFwDgdb6Cy_L__qL56H&si=t68X1emjrvOwTYQT)
...
- npm
- HTTP Module
- How the event loop works (macro vs microtasks)
- What Libuv is (in simple terms)
- Difference between synchronous and asynchronous code
- How Node handles non-blocking I/O
- Understanding CommonJS vs ES Modules
- Using process and environment variables
- Understanding __dirname, __filename, require
...
<details>
  <summary>API Development 🛠️</summary>
  <br>
...
- WebRTC Implementation
 ...
 <details>
   <summary>Performance & Security 🛡️</summary>
<br>
...
- EventEmitter advanced usage (inheritance, custom events)
- Streams (Readable, Writable, Transform)
- Buffers and binary data basics
- Cluster module & Worker Threads
- Child Processes (spawn, exec)
- Node.js Profiler & Performance Hooks
- Async Hooks (for debugging async context)
- Error handling patterns in async code (try/catch, global error handlers, next(err))
- Node.js Debugging Tools (node --inspect, Chrome DevTools, VSCode debugger)
...
- 🐬 [MySQL Fundamentals Tutorial - CodeRK](https://youtu.be/K9o0mRuqzqQ?si=qqpNHnY3OXvKX3Sy).
- 🚀 [Advanced MySQL Techniques - Big Data](https://youtu.be/kb-_GbpH3sQ?si=0kYRmy6N0h92lXpq)
- 📚 [MySQL - TheNewBaghdad](https://youtube.com/playlist?list=PLF8OvnCBlEY25O_Ql0CrgQUAc5NVYkWF2&si=3NNmclm8uYJm6hA1)
- 🎓 [MySQL - freeCodeCamp.org](https://www.youtube.com/watch?v=HXV3zeQKqGY)
- 💡 [MySQL - Traversy Media](https://youtu.be/9ylj9NR0Lcg?si=f1LtNVDlqdmLgBGR)
</details>
...
<details>
  ...
  - 🐘 [PostgreSQL - Mohamed Gbreel](https://youtube.com/playlist?list=PLqmv-PiN1b7hLJ_2ktdE9YX7Ba_7UZq3f&si=UK_KOv-_lcUgs_5S)
  - 🔧 [PostgreSQL - Troi](https://www.youtube.com/watch?v=zw4s3Ey8ayo)
</details>
...
<details>
  ...
  - 🖥️ [SQL - Korsat X Parmaga](https://youtu.be/N-WPYk417yE?si=7MU3PrWX1Mu0PyVB)
  - 📋 [SQL - Metigator](https://youtube.com/playlist?list=PL4n1Qos4Tb6RP_OovpgjoHLkCVaYFy-aj&si=LGocJvsBHjusN5rM)
  - 🔬 [SQL - Kevin Stratvert](https://www.youtube.com/watch?v=h0nxCDiD-zg)
</details>
...
<details>
  ...
  - 📦 [SQLite Fundamentals](https://youtu.be/7DQnyLIXEZw?si=F5Jw9yfumRymJ_vg)
  - 🧩 [SQLite ](https://youtu.be/IBgWKTaG_Bs?si=zGHSoPgxEEFdq5P8)
</details>
...
<details>
  ...
  - 🚀 [Prisma Fundamentals](https://www.youtube.com/watch?v=RebA5J-rlwg)
  - 📚 [Prisma Playlist](https://youtube.com/playlist?list=PLf42-srNPbi1iwPI4pRMLIcbqW-lF5R9T)
...
<details>
  ...
  - 📋 [Sequelize Playlist](https://youtube.com/playlist?list=PLkqiWyX-_Lov8qmMOVn4SEQwr9yOjNn3f&si=zXOmykVHDdS70PCc)
  - 🔬 [Sequelize ](https://youtu.be/zA_HkejB-0s?si=7R7Znli0UCXyeBkx)
...
<br>
  ...
  - 🔍 [TypeORM Fundamentals](https://www.youtube.com/watch?v=Reb7ISQZCvA)
  - 💡 [TypeORM ](https://www.youtube.com/watch?v=JaTbzPcyiOE)
  - 🚀 [TypeORM ](https://www.youtube.com/watch?v=JfIvPDPUFo4)
</details>
...
- [ ] NestJS CLI installation and basic commands
...
<details>
  <summary>2. Database Integration 💾</summary>
  <br>
...
<details>
  <summary>3. Authentication & Authorization 🔐</summary>
  <br>
...
<details>
  <summary>4. Advanced Concepts 🎯</summary>
  <br>
...
<details>
  <summary>5. Performance & Security 🛡️</summary>
  <br>
...
<details>
  <summary>6. Deployment & DevOps 🚢</summary>
  <br>
...
- [NestJS - Youssef Abbas](https://youtube.com/playlist?list=PL5gCk5NdNx5-W_GivoyivrwGOlNnffTX4&si=Cwuv1AHkwYE_nJy9)
...
- 📹 [Docker - Free Code Camp - English](https://youtu.be/kTp5xUtcalw?si=BJxFN4oiawfRjuD7)
- 📹 [Docker - TechWorld with Nana - English](https://youtu.be/kTp5xUtcalw?si=BJxFN4oiawfRjuD7)
- 📹 [Docker Practical Course - Arabic](https://youtu.be/kTp5xUtcalw?si=BJxFN4oiawfRjuD7)
</details>
<details>
  <summary>Software Engineering : SDLC, Agile Workflow, DevOps Workflow</summary>
  <br>

- 📹 [Software Development Lifecycle (SDLC)](https://youtu.be/pES-vyion48?si=gvrv7Orwg4QtlZQa)
- 📹 [Agile Workflow](https://youtu.be/i-QyW8D3ei0?si=eT-KAuKxFtExf2PC)
</details>
<details>
  <summary>Operating Systems</summary>
  <br>

  - 📹 [Operating Systems - Berkeley](https://youtube.com/playlist?list=PLGLfVvz_LVvSuz6NuHAzpM52qKM6bPlCV&si=sjA2ZNRSyqkSJZ-1)
</details>
<details>
  <summary>Clean Code & Refactoring</summary>
<br>

- 📖 [Clean Code](https://youtube.com/playlist?list=PLGLfVvz_LVvSuz6NuHAzpM52qKM6bPlCV&si=sjA2ZNRSyqkSJZ-1)
- 📖 [Refactoring To Patterns](https://youtube.com/playlist?list=PLGLfVvz_LVvSuz6NuHAzpM52qKM6bPlCV&si=sjA2ZNRSyqkSJZ-1)
- 📖 [Martin Fowler](https://youtube.com/playlist?list=PLGLfVvz_LVvSuz6NuHAzpM52qKM6bPlCV&si=sjA2ZNRSyqkSJZ-1)
</details>
<details>
  <summary>Hosting</summary>
  <br>

- 📹 [Hosting Explained](https://youtu.be/GFwcrCQukHU?si=F8AvV86fKgHlVWrD)
- 📹 [Hosting Practical Guide](https://youtu.be/AXVZYzw8geg?si=mdJrUqjt-JSc8M-r)
</details>
